...
class MainWindow(qt.QMainWindow):
    ...
    def __init__(self, new_document=False, logging=False, file_arguments=None):
        ...
        screen_width, screen_height = functions.get_screen_size()
        initial_width = min(int(initial_width), screen_width)
        initial_height = min(int(initial_height), max(0, screen_height - 40))
